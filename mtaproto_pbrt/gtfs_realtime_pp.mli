...
val pp_feed_header_incrementality : Format.formatter -> Gtfs_realtime_types.feed_header_incrementality -> unit 
...
val pp_trip_descriptor_schedule_relationship : Format.formatter -> Gtfs_realtime_types.trip_descriptor_schedule_relationship -> unit 
...
val pp_vehicle_descriptor : Format.formatter -> Gtfs_realtime_types.vehicle_descriptor -> unit 
(** [pp_vehicle_descriptor v] formats v *)

val pp_trip_update_stop_time_event : Format.formatter -> Gtfs_realtime_types.trip_update_stop_time_event -> unit 
(** [pp_trip_update_stop_time_event v] formats v *)

val pp_trip_update_stop_time_update_schedule_relationship : Format.formatter -> Gtfs_realtime_types.trip_update_stop_time_update_schedule_relationship -> unit 
(** [pp_trip_update_stop_time_update_schedule_relationship v] formats v *)

val pp_trip_update_stop_time_update : Format.formatter -> Gtfs_realtime_types.trip_update_stop_time_update -> unit 
...
val pp_vehicle_position_vehicle_stop_status : Format.formatter -> Gtfs_realtime_types.vehicle_position_vehicle_stop_status -> unit 
(** [pp_vehicle_position_vehicle_stop_status v] formats v *)

val pp_vehicle_position_congestion_level : Format.formatter -> Gtfs_realtime_types.vehicle_position_congestion_level -> unit 
(** [pp_vehicle_position_congestion_level v] formats v *)

val pp_vehicle_position_occupancy_status : Format.formatter -> Gtfs_realtime_types.vehicle_position_occupancy_status -> unit 
...
val pp_translated_string_translation : Format.formatter -> Gtfs_realtime_types.translated_string_translation -> unit 
(** [pp_translated_string_translation v] formats v *)

val pp_translated_string : Format.formatter -> Gtfs_realtime_types.translated_string -> unit 
